...
**`kbb --backend sci docs/check-declared.cljk`** ([quickstart](docs/operator-quickstart.md)).
...
Do not trust this table. Re-take it: **`kbb --backend sci docs/check-declared.cljk`**. Every
